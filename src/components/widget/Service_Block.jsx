    ...
    <li className='group bg-white p-[30px] transition-all duration-300 ease-in-out hover:bg-black'>
      <div className='relative mb-9 h-[70px] w-[70px]'>
        ...
        <img
          ...
          width={70}
          height={70}
          className='absolute left-0 top-0 h-full w-full opacity-0 transition-all duration-300 ease-linear group-hover:opacity-100 hue-rotate-90'
          
        />
      </div>
      <h3 className='mb-4 block text-xl leading-tight -tracking-[0.5px] text-black group-hover:text-white xl:text-2xl xxl:text-[28px]'>
        <Link to='/service-details' className='hover:text-colorOrangyRed'>
          {title}
        </Link>
      </h3>
      <p className='mb-12 duration-300 text-black group-hover:text-white'>{text}</p>
      <Link
        to='/service-details'
