              ...
              <div className='mx-auto max-w-[910px] text-center'>
                ...
                <div className='block rounded-lg bg-white px-[30px] py-[50px] text-left shadow-[0_4px_60px_0_rgba(0,0,0,0.1)] sm:px-10'>
                  ...
                  >
                    ...
                    <div className='grid grid-cols-1 gap-6'>
                      ...
                      <div className='flex flex-col gap-y-[10px]'>
                        <label
                          htmlFor='login-email'
                          className='text-lg text-black font-bold leading-[1.6]'
                        >
                          Email address
                        </label>
                        <input
                          ...
                          className='rounded-[10px] border border-gray-300 bg-white px-6 py-[18px] font-bold text-black outline-none transition-all placeholder:text-slate-500 focus:border-colorGreen'
                          required=''
                        />
                      </div>
                      {/* Form Single Input */}
                      ...
                      <div className='flex flex-wrap justify-between gap-x-10 gap-y-4'>
                        ...
                        <div className='flex gap-x-8 gap-y-[10px]'>
                          ...
                          <label
                            htmlFor='login-check'
                            className='text-base text-black leading-[1.6]'
                          >
                            Remember me
                          </label>
                        </div>
                        ...
                        <Link
                          to='/reset-password'
                          className='text-base text-black hover:text-colorGreen'
                        >
                          Forgot password?
                        </Link>
                      </div>
                    ...
                    <button
                      type='submit'
                      className='button mt-7 block rounded-[50px] border-2 border-black bg-black py-4 text-white after:bg-colorGreen hover:border-colorGreen hover:text-white'
                    >
                      Sign in
                    </button>
                    {/* Form Group */}
                  ...
                  <div className='relative z-[1] mb-14 mt-9 text-center font-bold before:absolute before:left-0 before:top-1/2 before:-z-[1] before:h-[1px] before:w-full before:-translate-y-1/2 before:bg-[#EAEDF0]'>
                    <span className='inline-block text-black bg-white px-6'>Or</span>
                  </div>
                  {/* API login */}
                  <div className='flex flex-col gap-y-6'>
                    {/* Google API login Button */}
                    <a className='button flex w-full justify-center gap-x-4 text-black rounded-[50px] border-2 border-[#EAEDF0] bg-white py-4 hover:bg-slate-200 cursor-pointer'>
                    ...
                    <a className='button flex w-full justify-center gap-x-4 rounded-[50px] text-black border-2 border-[#EAEDF0] bg-white py-4 hover:bg-slate-200 cursor-pointer'>
                      <span className='hidden h-6 w-6 sm:inline-block'>
                        <img
